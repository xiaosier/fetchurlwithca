...
class Snoopy
{
    ...
    function _connect(&$fp)
    {
        ...
        if ($this->scheme == 'https') {
            ...
            if (isset($this->local_cert) || isset($this->passphrase)) {
                ...
                if (isset($this->local_cert))
                    $context_opts['ssl']['local_cert'] = $this->local_cert;
                if (isset($this->passphrase))
                    $context_opts['ssl']['passphrase'] = $this->passphrase;
            }
